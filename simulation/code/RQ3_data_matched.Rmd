...
ggplot() + 
  geom_point(data = table_test, aes(x = Grade, y = Effect_of_KSize, color = "Test Scores"), size = 2) + 
  geom_line(data = table_test, aes(x = Grade, y = Effect_of_KSize, color = "Test Scores")) + 
  geom_point(data = table_social, aes(x = Grade, y = Effect_of_KSize, color = "Non-Cognitive Scores"), size = 2) + 
  geom_line(data = table_social, aes(x = Grade, y = Effect_of_KSize, color = "Non-Cognitive Scores")) + 
  labs(
    x = "Grade", 
  ...
  scale_color_manual(values = c("Test Scores" = "brown", "Non-Cognitive Scores" = "darkolivegreen")) + 
  theme_minimal() + 
